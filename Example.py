...
pso = PSO(lambda x: modelo_benchmark(x, function, bounds),
          ...
          maxiter=500,  # amount of iteractions that each particle will make
...
# graph = Graph_cut(pso.history.position_region, pso.history.fitness_region, bounds, pso.gbest, pso.fit_gbest, pso.history.iter, pso.num_part)
# graph.pos_fit_3d()
# graph.pos_cov_area()
# graph.positions()
# graph.pos_fit_2d()
