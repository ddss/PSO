...
pso.history.region(2.0, 'down')
graph = Graph(pso.history.position_region, pso.history.fitness_region, pso.history._velocity, bounds, pso.gbest, pso.fit_gbest, pso.history.inter, number_particles)
print(pso.gbest)
print(pso.fit_gbest)
graph.pos_fit_3d()
graph.positions()
