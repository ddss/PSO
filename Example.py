...
Otimizacao = PSO(sup,inf,{'busca':'Otimo','algoritmo':'PSO','inercia':None,'aceleracao':'Constante','restricao':True},\
Num_particulas=30,itmax=3000,w=[0.9,0.4],args_model=args_model)
